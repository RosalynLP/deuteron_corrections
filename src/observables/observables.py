...
fp1_table = fp1_table.query('experiment == "BCDMS"')
fp2_table = fp1_table.query('experiment == "BCDMS"')
...
ax.errorbar(range(len(T_fp1)), T_fp1/T_fp2, yerr = T_fp1_errs/T_fp2, marker=".")
...
ax.vlines(startlocs_lines, 0.98, 1.02, linestyles='dashed')
ax.margins(x=0, y=0)